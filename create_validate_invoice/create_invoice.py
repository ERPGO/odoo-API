from variables import customer, product_name, product_price, invoice_line_description, currency_id

url = "https://erpgo-gez.odoo.com"
db = "erpgo-gez-prod-285440"
username = 'admin'
password = 'freebsd'
...
product_ids.append((0, 0,
                    {'product_id': product[0]['id'], 'name': invoice_line_description, 'price_unit': product_price,
